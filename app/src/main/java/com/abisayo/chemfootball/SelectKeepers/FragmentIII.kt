 ...
 * Use the [FragmentIII.newInstance] factory method to
 * create an instance of this fragment.
 */
class FragmentIII : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val view = inflater.inflate(R.layout.fragment_i_i_i, container, false)
    ...
    companion object {
         ...
         * @return A new instance of fragment FragmentIII.
         */
