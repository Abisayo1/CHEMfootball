 ...
 * Use the [FragmentVI.newInstance] factory method to
 * create an instance of this fragment.
 */
class FragmentVI : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val view = inflater.inflate(R.layout.fragment_v_i, container, false)
        ...
        if (myButton != null) {
            myButton.setOnClickListener {
                ...
                intent.putExtra(Constants.KEEPER, "FragmentVI")
    ...
    companion object {
         ...
         * @return A new instance of fragment FragmentVI.
         */
