...
class NoteRVAdapter(val context : Context,
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView){
        ...
        val classs = itemView.findViewById<TextView>(R.id.Class)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        holder.topic.setText(allNotes.get(position).topic)
        holder.classs.setText("Last Updated : " +allNotes.get(position).classs)
