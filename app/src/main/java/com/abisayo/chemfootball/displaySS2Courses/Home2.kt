 ...
 */
private lateinit var viewModels: SS2CoursesViewModel
private lateinit var courseRecyclerView: RecyclerView
private lateinit var adapters : SS2CoursesAdapter
...
class Home2 : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModels = ViewModelProvider(this).get(SS2CoursesViewModel::class.java)
