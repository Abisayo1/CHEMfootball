 ...
 */
private lateinit var viewModels: SS3CoursesViewModel
private lateinit var courseRecyclerView: RecyclerView
private lateinit var adapters : SS3CoursesAdapter
...
class Home3 : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModels = ViewModelProvider(this).get(SS3CoursesViewModel::class.java)

        viewModels.allCourses.observe(viewLifecycleOwner, Observer {
            adapters.updateCourseList(it)
        })
